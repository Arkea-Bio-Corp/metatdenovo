...
class NfcoreTemplate {
    ...
    public static String logo(workflow, monochrome_logs) {
        ...
        String.format(
            ...
            ${colors.green}             _   ___ _  _____   _   ${colors.reset}
            ${colors.green}            /_\\ | _ \\ |/ / __| /_\\  ${colors.reset}
            ${colors.green}           / _ \\|   / ' <| _| / _ \\ ${colors.reset}
            ${colors.green}          /_/ \\_\\_|_\\_|\\_\\___/_/ \\_\\ ${colors.reset}
